...
export default function Netflex(props: PageProps) {
  const Netflix = props.Netflix
  return (
    <>
      ...
      <div className="card-cantainer">
        {Netflix.map((e: any) => {
          return <Card key={e.id} poster={e.img.url} summary={e.description} name={e.title} videoPoster={e.mp4.url} />
        })}
      </div>
      <Footer />
    </>
