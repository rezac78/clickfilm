...
export default function Marvel(props: PageProps) {
        const Marval = props.Marval
        ...
        return (
                <>
                        ...
                        <div className="card-cantainer">
                                {Marval.map((e: any) => {
                                        return <Card key={e.id} poster={e.poster.url} videoPoster={e.mp4.url} summary={e.description} name={e.title} />
                                })}
                        </div>
                        <Footer />
                </>
